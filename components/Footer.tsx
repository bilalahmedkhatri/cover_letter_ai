          ...
          <div className="grid grid-cols-2 gap-8 md:col-span-2">
            <div>
              ...
              <ul className="mt-4 space-y-2">
                <li><a href="/" className="text-text-secondary hover:text-accent text-sm transition-colors">Home</a></li>
                <li><a href="/dashboard" className="text-text-secondary hover:text-accent text-sm transition-colors">Generator</a></li>
              </ul>
            </div>
            <div>
              <h4 className="text-sm font-semibold text-text-primary tracking-wider uppercase">Legal</h4>
              <ul className="mt-4 space-y-2">
                <li><a href="/about" className="text-text-secondary hover:text-accent text-sm transition-colors">About Us</a></li>
                <li><a href="/privacy" className="text-text-secondary hover:text-accent text-sm transition-colors">Privacy Policy</a></li>
                <li><a href="/terms" className="text-text-secondary hover:text-accent text-sm transition-colors">Terms of Service</a></li>
              </ul>
            </div>
          </div>
        </div>
