...
const Header: React.FC = () => {
  ...
  const navLinks = (
      <>
        <a href="/dashboard" className="text-text-primary hover:text-cyan-400 transition-colors">Dashboard</a>
        <a href="/about" className="text-text-secondary hover:text-cyan-400 transition-colors">About</a>
        <a href="/privacy" className="text-text-secondary hover:text-cyan-400 transition-colors">Privacy</a>
        <a href="/terms" className="text-text-secondary hover:text-cyan-400 transition-colors">Terms</a>
      </>
  );
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="md:hidden">
              <button onClick={() => setIsOpen(!isOpen)} className="text-text-primary hover:text-cyan-400 focus:outline-none" aria-label="Toggle mobile menu">
